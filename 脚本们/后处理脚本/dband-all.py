...
# 自动调整标签位置避免重叠
adjust_text(texts, arrowprops=dict(arrowstyle='-', color='gray', lw=3))
# 添加元素标签
...
# 保存图片
plt.tight_layout()
plt.savefig('dband_all_adsorption_english.png', dpi=300, bbox_inches='tight')
plt.savefig('dband_all_adsorption_english.pdf', bbox_inches='tight')
plt.savefig('dband_all_adsorption_english.svg', bbox_inches='tight')
