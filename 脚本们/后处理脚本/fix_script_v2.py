...
for or_ in np.arange(-0.5, 0.4, 0.01):
    ...
    # 获取当前切出的 Slab 的化学式
    # mode='hill' (默认) 会输出类似 Li21Y7Cl42 的格式，方便比较
    ...
    # 注意：ASE Hill表示法通常按字母顺序排序，例如 Cl42Li21Y7
...
if not found:
    print("Warning: Target formula 'Li21Y7Cl42' not found. Saving the last structure.")
